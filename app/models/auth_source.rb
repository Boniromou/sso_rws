class AuthSource < ActiveRecord::Base
  ...
  attr_accessible :auth_type, :name, :host, :port, :account, :account_password, :base_dn, :attr_login, :attr_firstname, :attr_lastname, :attr_mail, :onthefly_register, :domain, :is_internal
