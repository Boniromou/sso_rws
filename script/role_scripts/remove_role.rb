...
if ARGV.length != 3
  puts "Usage: ruby script/role_scripts/remove_role.rb <env> <app_name> <role_name>"
  puts "Example: ruby script/role_scripts/remove_role.rb development user_management tester"
  Process.exit
end
