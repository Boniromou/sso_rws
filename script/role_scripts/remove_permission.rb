...
if ARGV.length != 3 && ARGV.length != 4
  puts "Usage: ruby script/role_scripts/remove_permission.rb <env> <app_name> <target> <permission>"
  puts "Example: ruby script/role_scripts/remove_permission.rb development user_management system_user show"
  Process.exit
end
