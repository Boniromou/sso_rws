...
set :user, "swe"
set :group, "swe"
set :repo_host, 'esb-cbms-app01.snd10.gamesource.local'

# Define your application servers for integration environment here.
#   int - Integration
#   stg - Staging
#   prd - Production
role :app, 'esb-sso-app01.snd10.gamesource.local'

role :cronjob_app, 'esb-sso-app01.snd10.gamesource.local'
...
set :virtual_server_name, 'esb-sso-vapp01.snd10.gamesource.local'
