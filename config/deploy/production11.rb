...
set :user, "swe"
set :group, "swe"
set :repo_host, 'cbms-app01.prd11.gamesource.local'

# Define your application servers for integration environment here.
#   int - Integration
#   stg - Staging
#   prd - Production
role :app, 'esb-sso-app01.prd11.gamesource.local', 'esb-sso-app02.prd11.gamesource.local'

role :cronjob_app, 'esb-sso-app01.prd11.gamesource.local'
...
set :virtual_server_name, 'esb-sso-vapp01.prd11.gamesource.local'
