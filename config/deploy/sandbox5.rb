...
set :repo_host, 'repo.snd5.gamesource.local'
set :user, 'swe'
set :group, 'swe'
...
#   stg - Staging
#   prd - Production
role :app, 'sso-app01.snd5.gamesource.local'
...
set :virtual_server_name, 'sso-vapp01.snd5.gamesource.local'
