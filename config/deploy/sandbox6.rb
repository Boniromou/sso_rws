...
#   stg - Staging
#   prd - Production
role :app, 'sso-app01.snd6.gamesource.local'

role :cronjob_app, 'sso-app01.snd6.gamesource.local'
...
set :virtual_server_name, 'sso-vapp01.snd6.gamesource.local'
