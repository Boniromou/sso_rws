set :stages, %w(integration0 staging0 staging1 production0 sandbox0 sandbox2 smartocean2 mockup0 sandbox3 production3 production4 sandbox production ias_prd sandbox5 sandbox6)
